...
typedef int M3DVector2i[2];
typedef long M3DVector2l[2];
...
inline void m3dLoadVector2(M3DVector2i v, const int x, const int y)
{
    v[0] = x; v[1] = y;
}
inline void m3dLoadVector2(M3DVector2l v, const long x, const long y)
{
    v[0] = x; v[1] = y;
}
...
inline void     m3dCopyVector2(M3DVector2i dst, const M3DVector2i src) { memcpy(dst, src, sizeof(M3DVector2i)); }
inline void     m3dCopyVector2(M3DVector2l dst, const M3DVector2l src) { memcpy(dst, src, sizeof(M3DVector2l)); }
...
inline void m3dAddVectors2(M3DVector2i r, const M3DVector2i a, const M3DVector2i b)
{
    r[0] = a[0] + b[0];   r[1] = a[1] + b[1];
}
inline void m3dAddVectors2(M3DVector2l r, const M3DVector2l a, const M3DVector2l b)
{
    r[0] = a[0] + b[0];   r[1] = a[1] + b[1];
}
...
inline void m3dSubtractVectors2(M3DVector2i r, const M3DVector2i a, const M3DVector2i b)
{
    r[0] = a[0] - b[0]; r[1] = a[1] - b[1];
}
inline void m3dSubtractVectors2(M3DVector2l r, const M3DVector2l a, const M3DVector2l b)
{
    r[0] = a[0] - b[0]; r[1] = a[1] - b[1];
}
...
inline void m3dLoadPersProjInfo(M3DPersProjInfo& p, float fFov, float fAspect, float zMin, float zMax)
{
    p.fFov = fFov;
    p.fAspect = fAspect;
    p.zMin = zMin;
...
inline void m3dLoadOrthoProjInfo(M3DOrthoProjInfo& o, float xMin, float xMax, float yMin, float yMax, float zMin, float zMax)
{
    o.xMin = xMin;
    o.xMax = xMax;
    o.yMin = yMin;
...
inline void m3dMakePerspectiveMatrix(M3DMatrix44f mProjection, const M3DPersProjInfo& info)
{
    m3dMakePerspectiveMatrix(mProjection, info.fFov, info.fAspect, info.zMin, info.zMax);
}

inline void m3dMakeOrthographicMatrix(M3DMatrix44f mProjection, const M3DOrthoProjInfo& info)
{
    m3dMakeOrthographicMatrix(mProjection, info.xMin, info.xMax, info.yMin, info.yMax, info.zMin, info.zMax);
}

void m3dMakeCameraMatrix(M3DMatrix33f m, const M3DVector3f target, const M3DVector3f up);
...
inline void m3dRotationMatrix33(M3DMatrix33f m, const M3DVector4f vRotation)
{
    m3dRotationMatrix33(m, vRotation[0], vRotation[1], vRotation[2], vRotation[3]);
}

inline void m3dRotationMatrix33(M3DMatrix33d m, const M3DVector4d vRotation)
{
    m3dRotationMatrix33(m, vRotation[0], vRotation[1], vRotation[2], vRotation[3]);
}

inline void m3dRotationMatrix44(M3DMatrix44f m, const M3DVector4f vRotation)
{
    m3dRotationMatrix44(m, vRotation[0], vRotation[1], vRotation[2], vRotation[3]);
}

inline void m3dRotationMatrix44(M3DMatrix44d m, const M3DVector4d vRotation)
{
    m3dRotationMatrix44(m, vRotation[0], vRotation[1], vRotation[2], vRotation[3]);
}
...
inline void m3dTranslationMatrix44(M3DMatrix44f m, M3DVector3f vTrans)
{
    m3dTranslationMatrix44(m, vTrans[0], vTrans[1], vTrans[2]);
}

inline void m3dTranslationMatrix44(M3DMatrix44d m, M3DVector3d vTrans)
{
    m3dTranslationMatrix44(m, vTrans[0], vTrans[1], vTrans[2]);
}
